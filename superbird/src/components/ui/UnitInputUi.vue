...
<template>
  <div class="relative flex h-8 min-w-0 items-center font-mono bg-input rounded-lg border border-input-border focus-within:border-input-border-focus outline-3 outline-transparent focus-within:outline-secondary/10 transition-colors duration-150">
    <!-- Number input -->
    <input
