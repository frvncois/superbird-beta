...
export function createDefaultGlobalStyles(): GlobalStyles {
  const defaultTypography = (): TypographySettings => ({
    ...
    baseLineHeight: '1.5',
    headings: {
      h1: { fontSize: '48px', fontWeight: '700', lineHeight: '1.1' },
    ...
    link: { color: 'var(--global-primary)', hoverColor: 'var(--global-secondary)', decoration: 'underline' },
  })
  ...
  return {
    ...
    typography: {
      desktop: defaultTypography(),
      tablet: {
        ...defaultTypography(),
        headings: {
          h1: { fontSize: '36px', fontWeight: '700', lineHeight: '1.1' },
